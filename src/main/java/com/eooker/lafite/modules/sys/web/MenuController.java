...
public class MenuController extends BaseController {
	...
	public String save(Menu menu, Model model, RedirectAttributes redirectAttributes) throws LafiteException {
	...
	public String delete(Menu menu, RedirectAttributes redirectAttributes) throws LafiteException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/menu/";
		}
...
//			}
	...
	public String updateSort(String[] ids, Integer[] sorts, RedirectAttributes redirectAttributes) throws LafiteException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/menu/";
		}
