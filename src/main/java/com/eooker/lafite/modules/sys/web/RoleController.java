...
public class RoleController extends BaseController {
	...
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) throws LafiteException {
	...
	public String delete(Role role, RedirectAttributes redirectAttributes) throws LafiteException {
		if(!UserUtils.getUser().isAdmin() && role.getSysData().equals(Global.YES)){
			addMessage(redirectAttributes, "越权操作，只有超级管理员才能修改此数据！");
			return "redirect:" + adminPath + "/sys/role/?repage";
		}
...
//			}
	...
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) throws LafiteException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
	...
	public String assignRole(Role role, String[] idsArr, RedirectAttributes redirectAttributes) throws LafiteException {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/sys/role/assign?id="+role.getId();
		}
