...
<html>
<head>
	<title>electricFlow WebSocket</title>
	<script type="text/javascript"src="http://echarts.baidu.com/gallery/vendors/echarts/echarts-all-3.js"></script>
</head>
<body>
	<div class="page-header" id="tou">电表数据</div>
...
<script type="text/javascript">
	...
	if ('WebSocket' in window) {
		...
		//"ws://120.78.230.108:8888/Lafite/webSocket/electric"
		websocket = new WebSocket("ws://127.0.0.1:8080/Lafite/webSocket/electric");
	} else {
